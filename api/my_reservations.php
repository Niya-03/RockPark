...
$stmt = $conn->prepare("SELECT date, start_time, end_time, r.name, res.id FROM reservations res JOIN rooms r ON res.room_id = r.id 
WHERE res.user_id = ? ORDER BY date DESC, start_time ASC");
